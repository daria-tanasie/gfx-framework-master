...
void Lab7::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, const glm::vec3 &color)
{
    ...
    int loc = glGetUniformLocation(shader->GetProgramID(), "light_position");
    ...
    int obj_cl = glGetUniformLocation(shader->GetProgramID(), "object_color");
    glUniform3fv(obj_cl, 1, glm::value_ptr(color));
