...
void Lab2::Init()
{
...

    {
        ...
        meshes["tetr_A"] = new Mesh("generated tetr 1");
        meshes["tetr_A"]->InitFromData(vertices, indices);
...

    {
        ...
        meshes["pat_A"] = new Mesh("generated pat 1");
        meshes["pat_A"]->InitFromData(vertices, indices);

        CreateMesh("pat_A", vertices, indices);
    }
...

    {
        ...
        meshes["pat_b"] = new Mesh("generated pat 1");
        meshes["pat_b"]->InitFromData(vertices, indices);

        CreateMesh("pat_b", vertices, indices);
    }

    {
        ...
        meshes["pat_c"] = new Mesh("generated pat 1");
        meshes["pat_c"]->InitFromData(vertices, indices);

        CreateMesh("pat_c", vertices, indices);
    }

    {
        ...
        meshes["pat_d"] = new Mesh("generated pat 1");
        meshes["pat_d"]->InitFromData(vertices, indices);

        CreateMesh("pat_d", vertices, indices);
    }
}
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(1.0f, 1.0f, 0), glm::vec3(0.25f));


    
    // TODO(student): Draw the tetrahedron

    RenderMesh(meshes["tetr_A"], shaders["VertexColor"], glm::vec3(1.5f, 2.0f, 0), glm::vec3(0.25f));

    // TODO(student): Draw the square
    RenderMesh(meshes["pat_A"], shaders["VertexColor"], glm::vec3(2.0f, 1.0f, 0), glm::vec3(0.25f));
    RenderMesh(meshes["pat_b"], shaders["VertexColor"], glm::vec3(0.0f, 0.0f, 0), glm::vec3(0.25f));
    RenderMesh(meshes["pat_c"], shaders["VertexColor"], glm::vec3(0.0f, 0.0f, 0), glm::vec3(0.25f));
    RenderMesh(meshes["pat_d"], shaders["VertexColor"], glm::vec3(0.0f, 0.0f, 0), glm::vec3(0.25f));
